return {
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader>te', '<cmd>Telescope file_browser<CR>', {noremap=true, silent=true})
        -- vim.keymap.set('n', '<leader>tp', '<cmd>Telescope projects<CR>', {noremap=true, silent=true})
